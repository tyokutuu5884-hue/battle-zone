        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 28 }}>
          {[
            ...
            animation: phase === "done" && p.win ? "bz-winner-glow 5s ease-in-out 0.5s infinite" : "none",
              ...
              {/* 勝者シマー */}
              {p.win && phase === "done" && <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg,transparent 40%,rgba(255,68,34,0.05) 50%,transparent 60%)", backgroundSize: "300% 100%", animation: "bz-shimmer 6s linear infinite", borderRadius: 14, pointerEvents: "none" }} />}
