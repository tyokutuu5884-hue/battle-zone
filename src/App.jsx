      ...
      {tab === "tables" && (
        <div style={S.body}>
          ...
          {[...pendingMatches].sort((a, b) => {
            ...
            return (
              <div key={m.id} className={isMyMatch ? "bz-match-card-my" : ""} style={{ background: isMyMatch ? "#fff8f7" : C.card, border: `2px solid ${isMyMatch ? C.accent : C.border}`, borderRadius: 14, padding: "18px 16px", marginBottom: 12, boxShadow: isMyMatch ? `0 0 16px ${C.accent}22` : "0 1px 6px #00000010", position: "relative", overflow: "hidden" }}>
