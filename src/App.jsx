        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 28 }}>
          {[
            ...
            <div key={i} style={{
              ...
              animation: phase === "slam" || phase === "counting" || phase === "done"
                ? `bz-slam-in 0.45s cubic-bezier(.22,.68,0,1.2) ${i * 0.12}s both${p.win && phase === "done" ? ", bz-winner-glow 1.8s ease-in-out 0.5s infinite" : ""}`
                : "none",
              position: "relative", overflow: "hidden",
            }}>
              {/* 勝者シマー */}
              {p.win && <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg,transparent 40%,rgba(255,68,34,0.07) 50%,transparent 60%)", backgroundSize: "300% 100%", animation: "bz-shimmer 2s linear infinite", borderRadius: 14, pointerEvents: "none" }} />}
              ...
              <div style={{
                ...
                letterSpacing: -1,
                animation: phase === "counting" ? "bz-count-shake 0.08s linear infinite" : "none",
              ...
              {phase === "done" && (
                <div style={{
                  marginTop: 8, fontSize: 10, fontWeight: 800, letterSpacing: 1.5,
                  color: p.win ? C.accent : C.muted,
                  textTransform: "uppercase",
                  opacity: 1, animation: "bz-diff-pop 0.4s 0.15s both",
