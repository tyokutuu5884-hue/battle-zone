  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "'Hiragino Sans','Yu Gothic UI',sans-serif", background: "linear-gradient(135deg,#f0f2f6 0%,#e8eaf0 50%,#f0f2f6 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ background: "#ffffff", borderRadius: 16, padding: "28px 24px", boxShadow: "0 4px 24px #0009", border: `1px solid ${C.border}` }}>
        ...
        {mode === "top" && (
          <div>
            ...
            {myTournaments.length > 0 && (
              <div style={{ background: "#ffffff", borderRadius: 16, padding: "20px", marginBottom: 12, border: `1px solid ${C.border}`, boxShadow: "0 4px 24px #0009" }}>
            ...
            {/* 新規作成・参加 */}
            <div style={{ background: "#ffffff", borderRadius: 16, padding: "24px", boxShadow: "0 4px 24px #0009", border: `1px solid ${C.border}` }}>
