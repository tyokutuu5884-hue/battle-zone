...
// ─── Design ──────────────────────────────────────────────────
const C = {
  bg: "#0a0c14",        // 深夜の空：濃いネイビー
  card: "#12151f",      // カード：少し明るいネイビー
  border: "#1e2235",    // ボーダー：ネイビー
  border2: "#2e2040",   // 強ボーダー：ダークパープル
  accent: "#ff4422",    // メインアクセント：燃える赤オレンジ
  accent2: "#cc2200",   // サブアクセント：深い赤
  green: "#00d4aa",     // 成功：青みがかったネオングリーン
  red: "#ff3355",       // エラー
  orange: "#ff8c00",    // 警告：ネオンオレンジ
  text: "#e8eeff",      // テキスト：青白い夜景色
  sub: "#a0aac8",       // サブテキスト：グレーブルー
  muted: "#5a6480",     // ミュート
  dim: "#161a28",       // 薄背景：ダークネイビー
};
