...
// ─── Tier ────────────────────────────────────────────────────
function getTier(r) {
  if (r >= 1800) return { label: "MASTER",   color: "#fbbf24", bg: "#2a1500", border: "#d97706" };
  if (r >= 1650) return { label: "DIAMOND",  color: "#a78bfa", bg: "#1a0a2e", border: "#7c3aed" };
  if (r >= 1575) return { label: "PLATINUM", color: "#34d399", bg: "#002a1a", border: "#059669" };
  if (r >= 1525) return { label: "GOLD",     color: "#fbbf24", bg: "#2a1e00", border: "#92400e" };
  if (r >= 1475) return { label: "SILVER",   color: "#94a3b8", bg: "#1e2a3a", border: "#475569" };
  return                { label: "BRONZE",   color: "#cd853f", bg: "#2a1800", border: "#7a4a10" };
}
