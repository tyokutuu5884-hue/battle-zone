      ...
      {tab === "tables" && (
        <div style={S.body}>
          ...
          {pendingMatches.map(m => {
            ...
            return (
              <div key={m.id} style={{ background: "#2a1212", border: `2px solid ${C.border2}`, borderRadius: 14, padding: "18px 16px", marginBottom: 12, boxShadow: "0 2px 8px #0000000a", position: "relative" }}>
